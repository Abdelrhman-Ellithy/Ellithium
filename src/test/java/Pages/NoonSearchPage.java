...
public class NoonSearchPage {
    ...
    private final By dellBtn = By.xpath("//a[contains(@href, '/electronics-and-mobiles/dell/')]");
    ...
    public String getTextInSearchField() {
        return driverActions.elements().getAttributeValue(searchField, "value", 10, 500);
    }
